...
describe(`3 Teste para a função numbers`, () => {
it(`testa se a função recebe [1, 2, '3', 4, 5] e retorna false`, () => {
expect(numbers([1, 2, '3', 4, 5])).toBeFalsy()
});
});

describe(`4 Teste para a função numbers`, () => {
  it(`Escreva um teste em que a função recebe [1, 'a', 3] e retorna false`, () => {
  expect(numbers([1,'a', 3])).toBeFalsy()
});
});

describe(`5 teste para a função numbers`, () => {
